...
palette.o: src/file/formats/palette.c src/file/formats/palette.h src/file/formats/palettes/ascii_palette.h src/file/formats/palettes/binary_palette.h src/file/formats/palettes/ansi_palette.h
	$(CXX) $(CXXFLAGS) $< -o $@
