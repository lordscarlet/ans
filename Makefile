...
file.o: src/file/file.c src/file/file.h src/file/formats/screen.h src/file/sauce.h src/image/canvas.h src/file/formats/artworx.h src/file/formats/binary.h src/file/formats/icedraw.h src/file/formats/pcboard.h src/file/formats/tundra.h src/file/formats/xbin.h
	$(CXX) $(CXXFLAGS) $< -o $@
